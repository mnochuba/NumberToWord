...
#                                                                             
# PROGRAMMER: MURPHY OCHUBA
# DATE CREATED: 5TH APRIL, 2020                               
# REVISED DATE: 
...
def classify_images(images_dir, results_dic, model):
    ...
    """
    list_of_pet_images = listdir(images_dir)
    count = 0
    ...
    for key in results_dic:
       ...
       file_name_plus_dir = images_dir + list_of_pet_images[count]
       model_label = classifier(file_name_plus_dir, model)
       count += 1
